...
class PricingEngine:
    ...
    def _get_pricing_rules(self, product):
        ...
        return {
            ...
            'stock_threshold_high': rule.stock_threshold_high if rule.stock_threshold_high else 60,
            'stock_threshold_excess': rule.stock_threshold_excess if rule.stock_threshold_excess else 80,
